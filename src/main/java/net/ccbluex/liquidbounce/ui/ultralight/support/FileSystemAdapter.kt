 ...
 *
 *
 * This implementation is based on NIO [FileChannel]s, as they can be used for easy mapping.
 *
 *
...
class FileSystemAdapter : UltralightFileSystem {
    ...
    private val openFiles: MutableMap<Long, FileChannel> = HashMap()
    ...
    private val logger = LogManager.getLogger("Ultralight-FileSystem")
