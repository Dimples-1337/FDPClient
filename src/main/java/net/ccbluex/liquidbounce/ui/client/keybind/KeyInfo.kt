...
class KeyInfo(
    ...
    fun render() {
        ...
        (if (hasKeyBind) {
            ...
            .drawCenteredString(
                keyName, width * 0.5F, height * 0.9F * 0.5F - (Fonts.font18.FONT_HEIGHT * 0.5F) + 3F, if (hasKeyBind) {
                    usedColor
                } else {
                    unusedColor
                }, false
    ...
    fun renderTab() {
        ...
        RenderUtils.drawRect(
            0F,
            baseTabHeight - 22F - Fonts.font20.height,
        ...
        Fonts.font20.drawString(
            "%ui.keybind.add%",
            baseTabWidth - 12F - Fonts.font20.getStringWidth("%ui.keybind.add%"),
            baseTabHeight - 12F - Fonts.font20.height,
