...
class Strafe : Module() {
    ...
    private var smoothValue = BoolValue("Smooth", false)
    ...
    fun onUpdate(event: UpdateEvent) {
        ...
        mc.thePlayer.motionX = strengthValue.get() *mc.thePlayer.motionX + (1-strengthValue.get()) * mc.thePlayer.MotionX;
        mc.thePlayer.motionY = strengthValue.get()*mc.thePlayer.motionY + (1-strengthValue.get()) * mc.thePlayer.motionY;
        mc.thePlayer.motionZ = strengthValue.get()*mc.thePlayer.motionZ + (1-strengthValue.get()) * mc.thePlayer.MotionZ;
            }
        } else {
            jump = false
        }
